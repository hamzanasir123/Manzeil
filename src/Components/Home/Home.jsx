...
export default function Home() {
    return (
       <>
            ...
            <div className="">
                ...
                src="https://img.freepik.com/free-vector/men-accessories-illustration-background_1284-20853.jpg?uid=R160414423&ga=GA1.1.939566532.1722205101&semt=ais_hybrid" 
                alt="image2" />
            </div>
        <div>
      ...
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-lg font-black text-black ">MEN</h1>
    ...
    <li>
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-lg font-black text-black">MUGS</h1>
        <button className="mt-2 inline-flex cursor-pointer items-center text-sm font-semibold text-black">
          View all &rarr;
        </button>
      </div>
    ...
    <li>
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-lg font-black text-black">UNISEX</h1>
        <button className="mt-2 inline-flex cursor-pointer items-center text-sm font-semibold text-black">
          View all &rarr;
        </button>
      </div>
    ...
    <li>
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-lg font-black text-black">BADGES</h1>
        <button className="mt-2 inline-flex cursor-pointer items-center text-sm font-semibold text-black">
          View all &rarr;
        </button>
      </div>
    ...
    <li>
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-lg font-black text-black">HOODIES</h1>
        <button className="mt-2 inline-flex cursor-pointer items-center text-sm font-semibold text-black">
          View all &rarr;
        </button>
      </div>
    ...
    <li>
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-lg font-black text-black">PHONE CASES</h1>
        <button className="mt-2 inline-flex cursor-pointer items-center text-sm font-semibold text-black">
          View all &rarr;
        </button>
      </div>
      ...
      <ul className='flex ml-10'>
        <li>
        <div className=" hover:shadow-xl hover:cursor-pointer relative h-[300px] w-[300px] rounded-xl">
          <img
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-2xl font-black text-gray-500">Huge Product Variety</h1>
        <p className="mt-2 text-sm text-black">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, debitis?
        </p>
      </div>
      ...
      <ul className='flex bg-slate-100 mb-20'>
      <li className="flex">
        <div className="ml-36 hover:shadow-xl hover:cursor-pointer relative h-[300px] w-[300px] rounded-xl">
          <img
          src='https://manzeil.com/wp-content/uploads/2020/10/t-shirt-ap.png'
          alt='Shirt'
          className='size-36  '
          />
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-2xl font-black text-gray-500">Affordable Printing</h1>
        <p className="mt-2 text-sm text-black">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, debitis?
        </p>
      </div>
        ...
        <div className="ml-36 hover:shadow-xl hover:cursor-pointer relative h-[300px] w-[300px] rounded-xl">
          <img
          src='https://manzeil.com/wp-content/uploads/2020/10/thumbs-up-1.png'
          alt='Shirt'
          className='size-36  '
          />
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-2xl font-black text-gray-500">High Quality Printing</h1>
        <p className="mt-2 text-sm text-black">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, debitis?
        </p>
      </div>
        ...
        <div className="ml-36 hover:shadow-xl hover:cursor-pointer relative h-[300px] w-[300px] rounded-xl">
          <img
          src='https://manzeil.com/wp-content/uploads/2020/10/shipping-1.png'
          alt='Shirt'
          className='size-36  '
          />
      {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent"></div> */}
      <div className="absolute bottom-4 left-4 text-left">
        <h1 className="text-2xl font-black text-gray-500">US & Global Shiping</h1>
        <p className="mt-2 text-sm text-black">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, debitis?
        </p>
      </div>
      ...
      <div>
        <h1
        className='text-blue-500 font-black text-center'
        >TOP SALE ON THIS WEEK</h1>
        <h1
        className='text-center font-black text-5xl'
        >Features Products</h1>
        <p
        className='text-center'
        >Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem, corrupti. Magni.</p>
      </div>
  ...
  <div
    class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://manzeil.com/wp-content/uploads/2024/08/GET-THE-APP-800x800.png')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
    <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t from-black/80 via-black/50"></div>
  </div>
  <div class="relative p-6 px-6 md:px-12">
    <h5 class="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-300">
    AFFECTION – Inspired by Ganymede Marc Antoine Barrois
    </h5>
    <p className='line-through text-gray-300'>Rs 2850</p>
    <p className='text-white font-bold mb-5'>Rs 2550</p>
<a
...
>
  ...
  <div class="flex items-center">
    <span class="ml-1 text-white">Add To Cart</span>
  </div>
  <div class="ml-2 flex items-center gap-1 text-sm md:flex">
    ...
    <span
      ...
      <li className='flex ml-16 mt-14'>
      <div
  class="relative grid h-[30rem]  max-w-[22rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
  <div
    class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://manzeil.com/wp-content/uploads/2020/09/product-w-jeans2-800x800.jpg')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
    <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t from-black/80 via-black/50"></div>
  </div>
  <div class="relative p-6 px-6 md:px-12">
    <h5 class="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-300">
...
>
  ...
  class="relative grid h-[30rem]  max-w-[20rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
  <div
    class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://manzeil.com/wp-content/uploads/2020/09/product-accessory3-800x800.jpg')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
    <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t from-black/80 via-black/50"></div>
  </div>
  <div class="relative p-6 px-6 md:px-12">
    <h5 class="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-300">
...
>
  ...
  class="relative grid h-[30rem]  max-w-[20rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
  <div
    class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://manzeil.com/wp-content/uploads/2024/08/001-01-800x800.png')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
    <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t from-black/80 via-black/50"></div>
  </div>
  <div class="relative p-6 px-6 md:px-12">
    <h5 class="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-300">
    Business Elegance | Impression of Office For Men
    </h5>
    <p className='line-through text-gray-300'>Rs 2850</p>
    <p className='text-white font-bold mb-5'>Rs 2550</p>
<a
...
>
  ...
  class="relative grid h-[30rem]  max-w-[22rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
  <div
    class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://manzeil.com/wp-content/uploads/2020/09/men-fashion-free-img.jpg')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
    <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t from-black/80 via-black/50"></div>
  </div>
  <div class="relative p-6 px-6 md:px-12">
    <h5 class="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-300">
