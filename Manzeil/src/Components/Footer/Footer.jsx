...
export default function Footer() {
    return (
        ...
        //                     <img
        //                          src="https://img.freepik.com/free-vector/hand-drawn-flat-design-anarchy-symbol_23-2149244760.jpg?size=626&ext=jpg&ga=GA1.1.939566532.1722205101&semt=ais_hybrid"
        //                          className="mr-7 h-18 size-20"
        //                          alt="Logo"
        //                      />
        ...
        //     </div>
        // </footer>
        <div className="w-full mt-12  bg-slate-500">
        <footer className="px-4 py-10">
          <div className="mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div className="mb-8 lg:mb-0">
              <p className="mb-6 text-lg font-semibold text-white">Quick Links</p>
              <ul className="flex flex-col space-y-4 text-[14px] font-medium text-white">
                <li>
                <NavLink
                        to=""
            ...
            <div className="mb-8 lg:mb-0">
              <p className="mb-6 text-lg font-semibold text-white">Discover</p>
              <ul className="flex flex-col space-y-4 text-[14px] font-medium text-white">
                <li>
                <NavLink
                        to=""
